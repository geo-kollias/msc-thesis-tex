...
to return
 \item
  \texttt{bfTree}: the AST of the implicit \sv{scala.\allowbreak{}collection.\allowbreak{}generic.CanBuildFrom} \fxfatal{cite adrian moors phd} object that got
...
transformed to something like \sv{def local1(x: Int): Int =
x.+(TestMacroMapObject.this.y)}. Also, a closure like \sv{{println("hi"); x =>
x + 1}} would be transformed to 
\begin{scalaCode}
println("hi");
...
\subsection{\texttt{Array}, \sv{scala.collection.mutable.ArraysOps}  and
\sv{scala.\allowbreak{}collection.\allowbreak{}mutable.\allowbreak{}IndexedSeq} Transformation}
...
sequences. The exact transformation is \fxfatal{defined on lines XX-YY}:
...
\subsection{\sv{scala.collection.LinearSeq} Transformation}
...
\sv{\allowbreak{}mutable.\allowbreak{}DoubleLinkedList}\}}. All of these collections are linear.
...
constant. The transformation is: \fxfatal{defined on lines XX-YY}.
...
\subsection{\sv{scala.collection.Traversable} Transformation}
...
previous transformations. The transformation is: \fxfatal{defined on lines XX-YY}
