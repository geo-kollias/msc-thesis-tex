...
\texttt{macroMap} is defined in \sv{scala.collection.TraversableLike} trait, where the
...
\sv{scala.collection.generic.Builder} objects depeding on their type parameters.
...
\sv{scala.collection.TraversableOnce} trait and \texttt{Array}s, through Scala's implicit
...
\texttt{Symbol} of an application of the \sv{scala.collection.TraversableLike} trait's
