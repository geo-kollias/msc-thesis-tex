...
backing the Scala ecosystem, about Scala shortcomings, leaked to the public\fxfatal{cite http://www.infoq.com/news/2011/11/yammer-scala}. Most technical issues were
...
the implementation is based on Paul Phillips's original \textsc{declosurify} project\fxfatal{cite github url}. 
