...
Cliff Click describes an issue that has emerged the last few years in the JVM ecosystem in his ``Fixing The Inlining Problem'' blog post~\cite{cliffc:TheProblem}:
